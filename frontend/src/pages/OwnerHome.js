...
import OwnerNavbar from '../components/OwnerNavbar'; // Correct path
...
const OwnerHome = () => {
  ...
  const handleDeleteGround = async (groundId) => {
    ...
    if (isConfirmed) {
      try {
        await axios.delete(`http://localhost:8080/api/grounds/delete/${groundId}`);
        // Filter the list to remove the deleted ground
                  ...
                  <div className="ground-details">
                    ...
                    <div className="ground-footer">
                      ...
                      <div className="dropdown">
                        ...
                        <div className={`dropdown-content ${activeDropdown === ground.gId ? 'show' : ''}`}>
